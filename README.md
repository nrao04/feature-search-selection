...
If you use Conda, activate your env first — same command after that.
...
- Small: `{3, 5, 7}`
- Large: `{1, 5, 17}` — must stay ≤ 18; an old handout example used feature 27 on a different 27-feature file.
